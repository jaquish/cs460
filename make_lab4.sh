...
echo linking...
ld86 -o out/4_mtx -d build/4_multi_s.o /build/4_multi_c.o /usr/lib/bcc/libc.a
...
echo linking...
ld86 -o out/4_u1 build/4_u1_s.o build/4_u1_c.o /usr/lib/bcc/libc.a
...
cp out/4_u1  ./mp/bin/4_u1 					# copy u1
sudo umount -f ./mp
